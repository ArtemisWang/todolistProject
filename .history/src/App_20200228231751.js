...
const App=function(){
    ...
    const [done, setDone]=useState(['unline','line-through','',''])
    ...
    <div className='app'>
        ...
        <div className='u-list'>
            <ul className={`todo-list`}>
                {list.map((it,i)=>(<li key={it+i} onClick={hasDone.bind(this,i)} style={{textDecoration:done[i]}}>{it}</li>))}
            </ul>
        </div>
    </div>)
}
